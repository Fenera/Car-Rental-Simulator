...
public class Rental implements Iterable {
    ...
    public String toString() {
        return String.format("""
            ...
            +────────────────────────────────────────
           \s""",
                rentalID, vehicle.getVIN(),
                vehicle.getManufacturer() + " " + vehicle.getModel(),
                2025, customer.getClientID(),
                employee.getStaffID(), rate, startDate.toString(),
                endDate.toString(), endDate.getDayOfYear() - startDate.getDayOfYear()
        );
    }
